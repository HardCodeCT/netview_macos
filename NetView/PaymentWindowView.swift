            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 20) {
                    ...
                    VStack(alignment: .leading, spacing: 12) {
                        ...
                        // FIXED: macOS 12 compatible TextEditor
                        ZStack(alignment: .topLeading) {
                            ...
                            TextEditor(text: $walletAddress)
                                ...
                                .frame(height: 56)
                                .opacity(walletAddress.isEmpty ? 0.5 : 1.0)
                        }
...
struct WalletCardView: View {
    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            .padding(.top, 8)
            .padding(.bottom, 11)
            .netViewCursor(isHovered ? .pointingHand : .arrow)
        }
        .background(
...
// FIXED: Renamed to avoid conflict with MonitorView
extension View {
    func netViewCursor(_ cursor: NSCursor) -> some View {
